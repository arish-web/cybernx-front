...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    await registerUser(name, email, password, role as 'jobseeker' | 'employer', company); // Make sure 'role' is properly typed

    Notiflix.Notify.success('User registered successfully!');
    navigate('/login');
  } catch (err: any) {
    Notiflix.Notify.failure(err.message || 'Registration failed');
  }
};
  //-----updated-----//
